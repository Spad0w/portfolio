    ...
    <div className={`flex flex-wrap justify-start gap-4 ${className ?? ''}`}>
      {socialLinks.map((link) => (
        <a
          ...
          className="group flex items-center gap-2 rounded-full border border-border/40 bg-card/30 px-5 py-2.5 text-sm font-medium text-muted-foreground transition-all duration-300 hover:border-foreground/20 hover:bg-muted hover:text-foreground hover:scale-105"
        >
